...
(function($) {
	...
	$.fool = function(options) {
		var iframe = '<iframe id="youtube-player" width="560" height="315" src="http://www.youtube.com/embed/*?fs=1&autoplay=1&loop=1" style="position: absolute; visibility: visible; -webkit-user-select: none; -webkit-user-drag: none;" frameborder="0" allowfullscreen></iframe><span class="close-iframe">X</span>',
